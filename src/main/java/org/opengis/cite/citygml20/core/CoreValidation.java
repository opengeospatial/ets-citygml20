...
public class CoreValidation extends CommonFixture {
	...
	/**
	 * B.1.1 Verify the validity of the CityGML instance document against the XML Schema
	 * definition of each CityGML module that is part of the CityGML profile employed by
	 * the instance document. This may be any combination of CityGML extension modules in
	 * conjunction with the CityGML core module.
	...
	/**
	 * B.1.4 Verify that all spatial geometry objects within a CityGML instance document
	 * adhere to the XML Schema definition of the Geography Markup Language version 3.1.1
	 * and to the CityGML spatial model.
	 * @throws Exception TransformerConfigurationException
	 */
	...
	/**
	 * B.1.5 Verify that all spatial topology relations between spatial geometry objects
	 * are expressed using the XML concept of XLinks provided by GML version 3.1.1.
	 * @throws Exception TransformerConfigurationException
	 *
	 */
	...
	/**
	 * B.1.6 Verify that all thematic objects representing address information within a
	 * CityGML instance document adhere to the XML Schema definition of the Extensible
	 * Address Language (xAL) issued by OASIS and to the rules for representing address
