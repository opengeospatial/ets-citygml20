package org.opengis.cite.citygml20.level1;
...
import org.opengis.cite.citygml20.ErrorMessage;
import org.opengis.cite.citygml20.ErrorMessageKeys;
...
public class Capability1Tests extends CommonFixture {
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/citygml20/rnc/atom.rnc");
