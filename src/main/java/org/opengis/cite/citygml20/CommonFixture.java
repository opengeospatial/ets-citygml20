...
public class CommonFixture {
	 ...
	 * @return A boolean value indicates whether the XML document is valid with XSD
	 * Template or not
	 */
	...
	protected ArrayList<String> GetToValidateXsdPathArrayList(Document doc) {
		...
		hashMap.put(CityFurnitureModule.v2_0_0.getNamespaceURI(),
				"xsd/opengis/citygml/cityfurniture/2.0/cityFurniture.xsd");
		hashMap.put(CityObjectGroupModule.v2_0_0.getNamespaceURI(),
				"xsd/opengis/citygml/cityobjectgroup/2.0/cityObjectGroup.xsd");
		...
		hashMap.put(TransportationModule.v2_0_0.getNamespaceURI(),
				"xsd/opengis/citygml/transportation/2.0/transportation.xsd");
		...
		hashMap.put(TexturedSurfaceModule.v2_0_0.getNamespaceURI(),
				"xsd/opengis/citygml/texturedsurface/2.0/texturedSurface.xsd");
