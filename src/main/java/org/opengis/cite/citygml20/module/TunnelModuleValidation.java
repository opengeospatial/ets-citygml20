...
public class TunnelModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Tunnel module’s rules for
	 ...
	 * defined within the Tunnel module. Conformance requirements on referential integrity
	 * of CityGML property elements defined within the Tunnel module may be additionally
	...
	public void verifyTunnelModule() {
		...
		String[] moduleElementNameList = { "Tunnel", "TunnelInstallation", "IntTunnelInstallation", "TunnelFurniture",
				"HollowSpace", "TunnelPart" };
