...
public class BuildingModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Building module's rules for
	 ...
	 * defined within the Building module. Conformance requirements on referential
	 * integrity of CityGML property elements defined within the Building module may be
	 ...
	 * annex A.13. Clause 10.3.9 - Base Requirement 1. If a building only consists of one
	 * (homogeneous) part, it shall be represented by the element Building. However, if a
	 * building is composed of individual structural segments, it shall be modelled as a
	 * Building element having one or more additional BuildingPart elements.
	 */
	...
	public void verifyBuildingModule() {
		...
		String[] moduleElementNameList = { "Building", "BuildingInstallation", "IntBuildingInstallation",
				"BuildingFurniture", "Room", "BuildingPart" };
