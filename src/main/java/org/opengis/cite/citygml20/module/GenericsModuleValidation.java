...
public class GenericsModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Generics module’s rules for
	 ...
	 * defined within the Generics module. Conformance requirements on referential
	 * integrity of CityGML property elements defined within the Generics module may be
	...
	public void verifyGenericsModule() {
		...
		String[] moduleElementNameList = { "GenericCityObject", "genericAttributeSet", "stringAttribute",
				"doubleAttribute", "dateAttribute", "uriAttribute", "measureAttribute" };
