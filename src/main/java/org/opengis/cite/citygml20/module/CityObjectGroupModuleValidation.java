...
public class CityObjectGroupModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the CityObjectGroup module’s
	 ...
	 * employing elements defined within the CityObjectGroup module. Conformance
	 * requirements on referential integrity of CityGML property elements defined within
	 * the CityObjectGroup module may be additionally validated using the constraints
	 ...
	 * the CityObjectGroup module may be additionally validated using the constraints
	 * provided by the Schematron schema referentialIntegrity.sch in accordance with the
	 * rules and guidelines stated in annex A.15. Base Requirement 1. No cyclic groupings
	 * shall be included within a CityGML instance document.
	 * @throws Exception XPathExpressionException
	 */
