...
public class TransportationModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Transportation module’s rules
	 ...
	 * employing elements defined within the Transportation module. Conformance
	 * requirements on referential integrity of CityGML property elements defined within
	 * the Transportation module may be additionally validated using the constraints
	 * provided by the Schematron schema referentialIntegrity.sch in accordance with the
	...
	public void verifyTransportationModule() {
		...
		String[] moduleElementNameList = { "TrafficArea", "TransportationComplex", "AuxiliaryTrafficArea", "Track",
				"Railway", "Road", "Square" };
