...
public class ReliefModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Relief module’s rules for
	 ...
	 * defined within the Relief module. Conformance requirements on referential integrity
	 * of CityGML property elements defined within the Relief module may be additionally
	...
	public void verifyReliefModule() {
		...
		String[] moduleElementNameList = { "ReliefFeature", "TINRelief", "MassPointRelief", "BreaklineRelief",
				"RasterRelief" };
