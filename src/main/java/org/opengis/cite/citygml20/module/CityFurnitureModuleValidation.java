...
public class CityFurnitureModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the CityFurniture module’s rules
	 ...
	 * employing elements defined within the CityFurniture module. Conformance
	 * requirements on referential integrity of CityGML property elements defined within
	 * the CityFurniture module may be additionally validated using the constraints
