...
public class WaterBodyModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the WaterBody module’s rules for
	 ...
	 * defined within the WaterBody module. Conformance requirements on referential
	 * integrity of CityGML property elements defined within the WaterBody module may be
	...
	public void verifyWaterBodyModule() throws Exception {
		...
		Assert.assertTrue(validParent,
				"_WaterBoundarySurface elements shall only be included as parts of corresponding WaterBody elements.");
	}
