...
public class VegetationModuleValidation extends CommonFixture {
	...
	/**
	 * Verify that the CityGML instance document follows the Vegetation module’s rules for
	 ...
	 * defined within the Vegetation module. Conformance requirements on referential
	 * integrity of CityGML property elements defined within the Vegetation module may be
