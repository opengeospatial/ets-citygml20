...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/citygml20"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.citygml20.TestNGController">

  <ctl:function name="tns:run-ets-citygml20">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the citygml20 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:test name="tns:Main">
	  ...
	  <ctl:code>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-citygml20">
